[![Integration Tests](https://github.com/ishreyasp/task-manager-app/workflows/ci.yml/badge.svg)](https://github.com/ishreyasp/task-manager-app/actions/workflows/ci.yml)
